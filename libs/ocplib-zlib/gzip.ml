...
let skip_byte ic = ignore (input_byte ic : int)
...
let input_char iz =
  if input iz char_buffer 0 1 = 0 then raise End_of_file else
    Bytes.get char_buffer 0
